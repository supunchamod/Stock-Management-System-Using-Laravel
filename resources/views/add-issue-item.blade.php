...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Issue Item</h3>
                    <ul class="breadcrumb">
            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm">
                                <form class="needs-validation" action="/issue-item" method="post" novalidate>
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            <label for="validationCustom03">Issue By</label>
                                            <input type="text" class="form-control" name="issued_by" id="validationCustom03" placeholder="Pen" required>
                                            <div class="invalid-feedback">
                                                Please provide a valid city.
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label for="validationCustom03">Issue To</label>
                                            <input type="text" class="form-control" name="issued_to" id="validationCustom03" placeholder="Pen" required>
                                            <div class="invalid-feedback">
                                                Please provide a valid city.
                                            </div>
                                        </div>
